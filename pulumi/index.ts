...
const localImageName = "companies-test-service:" + imageVersion;

const imageName = repo + "/companies-test-service:" + imageVersion;
...
const svcAccount = new gcp.serviceaccount.Account(
    "service-account",
    {
	accountId: "companies-test-service",
	displayName: "Companies test service",
	description: "Companies test service",
    },
    {
	provider: provider,
	dependsOn: [],
